...
export class StatisticsItem extends ChildComponent {
   ...
   * 
   * @param {string} label - The value to be displayed in the
   * statistic item.
   * @param {string|number} value - The value to be displayed in the
   * statistic item.
   * @param {('purple'|'green')} variant - The variant that
   * determines the appearance of the statistics item. Allow values:
   * 'purple' or 'green'.
   */
