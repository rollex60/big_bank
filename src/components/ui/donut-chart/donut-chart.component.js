...
/**
 * DonutChart class for creating a simple donut width
...
export class DonutChart extends ChildComponent {
   ...
   * @param {string|HTMLElement} container - The container element
   * (either a selector or HTMLElement) where the chart will be
   * appended.
   * @param {object[]} data - An array of data objects to represent
   * each slice of the donut chart.
